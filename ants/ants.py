...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if hasattr(self.ant, 'fake_queen') and not insect.fake_queen:
                return
            if self.ant.is_container and self.ant.contained_ant:
                if isinstance(self.ant.contained_ant, QueenAnt) and not insect.fake_queen:
                    return
            # END Problem 13
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        i = 0
        while loc != hive:
            if loc.bees and i >= self.min_range and i <= self.max_range:
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.fake_queen:
            ...
            location = self.place
            while location:
                if not hasattr(location.ant, 'fake_queen'):
                    if location.ant and location.ant not in QueenAnt.Already_Doubled:
                        location.ant.damage *= 2
                        QueenAnt.Already_Doubled.append(location.ant)
                    if location.ant and location.ant.is_container:
                        if location.ant.contained_ant and location.ant.contained_ant not in QueenAnt.Already_Doubled:
                            location.ant.contained_ant.damage*=2
                            QueenAnt.Already_Doubled.append(location.ant.contained_ant)
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        self.armor -= amount
        if self.armor <=0 and not self.fake_queen:
            bees_win()
        # END Problem 13
